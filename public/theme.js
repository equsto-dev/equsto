(function () {
  ...
  /* Varsayılan: açık tema (sistem koyu moduna otomatik geçme). */
  try {
    document.documentElement.setAttribute("data-theme", "light");
    document.documentElement.classList.add("eq-vitrin-white-lock");
  } catch (_) {}
  ...
  /** KİLİT: vitrin-beyaz-zemin — admin + Bar Design (bd-page) hariç her zaman açık tema */
  ...
  /* Sistem teması değişince otomatik koyu yapma — varsayılan açık kalır. */
