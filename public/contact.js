...
(function () {
  ...
  function equstoShowWhatsAppModal(phoneDigits, plainText) {
    ...
    if (titleEl) titleEl.textContent = "Equsto Destek";
  ...
  function mountWaModal() {
    ...
    overlay.innerHTML =
      ...
      '<div class="equsto-wa-ico" aria-hidden="true">' +
      waSvg +
      "</div>" +
      '<h2 class="equsto-wa-title" id="equsto-wa-modal-title">Equsto Destek</h2>' +
