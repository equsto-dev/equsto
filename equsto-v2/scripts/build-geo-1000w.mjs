...
const SPECS = {
  ...
  "projeler": {
    konsept: "Equsto referans projeler ve demode vakalar",
    pfosKonu: "Catering",
    budget: "proje bazlı",
    blocks: [
      "Referans projeler demonte anlatımla ekipman seçim mantığını gösterir.",
      "İstanbul yüksek hacim catering ve İzmir modüler bar demode örnekleri listelenir.",
      "Vaka sayfaları vitrin SKU bağlantıları içerir.",
      "PFOS aynı kapasite girdileriyle yeniden üretilebilir.",
      "GEO aramalarında şeffaf proje yaşam döngüsü hedeflenir.",
    ],
    rehberLinks: "İlgili: /catering-mutfagi, /bar-tasarimi-turkiye.",
  },
  "projeler/istanbul-yuksek-hacim-catering-demode": {
    konsept: "İstanbul yüksek hacim catering demode",
    pfosKonu: "Catering",
    budget: "1,5 - 4 milyon TL",
    blocks: [
      "Toplu yemek ve banket çıkışında sıcak banket ile konveyörlü yıkama hattı modellenir.",
      "Pik kapak yüzde 70–85 bandında planlanır.",
      "Soğutma prep öğünden 24–48 saat önce başlar.",
      "500 kişilik catering rehberi aynı formülü açar.",
      "MEP ve yıkama darboğazı erken doğrulanır.",
    ],
    rehberLinks: "İlgili: /rehber/500-kisilik-catering-ekipman-planlama-2026, /projeler.",
  },
  "projeler/izmir-moduler-bar-icecek-demode": {
    konsept: "İzmir modüler bar ve içecek hattı demode",
    pfosKonu: "Bar",
    budget: "500 bin - 3 milyon TL",
    blocks: [
      "Modüler bar hattı Besos vitrin modülleriyle hizalanır.",
      "İçecek ekipmanları aynı saha projesinde planlanır.",
      "IMT300 berrak buz hattı içecek ağırlıklı konseptlere eklenir.",
      "Bar Design Studio çizimleri saha ölçüsüne göre üretilir.",
      "PFOS Bar konsepti modül adetlerini listeler.",
    ],
    rehberLinks: "İlgili: /bar-tasarimi-turkiye, /besos.",
  },
  "endustriyel-mutfak-ekipmani-turkiye": {
    konsept: "Türkiye endüstriyel mutfak ekipmanı tedariki",
    pfosKonu: "Restoran",
    budget: "proje bazlı",
    blocks: [
      "Equsto restoran, otel, kafe ve bulut mutfak için katalog ve satış mühendisliği sunar.",
      "Pişirme, soğutma, yıkama, hazırlık, kahve ve içecek departmanları gerçek SKU ile listelenir.",
      "Öztiryakiler yetkili bayii ve seçili markalar aynı teklif akışında birleşir.",
      "PFOS hedef 5 dakikada teklif özeti üretir.",
      "İhracat pazarları seçili ülkelerde aktif tedariktir.",
    ],
    rehberLinks: "İlgili: /oztiryakiler-ekipmani-tedarik, /shop/pisirme.",
  },
  "restoran-mutfak-teklif": {
    konsept: "restoran mutfak ekipman teklifi",
    pfosKonu: "Restoran",
    budget: "800 bin - 4 milyon TL",
    blocks: [
      "Menü, kapasite ve servis stili pişirme, soğutma ve yıkama adetlerini belirler.",
      "PFOS üç paket senaryosu üretir.",
      "Teklif özeti KDV ve lojistik kalemlerini içerir.",
      "Gastronomi Tasarımı yerleşim çizimi MEP sonrası kesinleşir.",
      "Steakhouse, cafe ve fine dining konsept rehberleri detay verir.",
    ],
    rehberLinks: "İlgili: /mutfak-teklif-platformu, /pfos.",
  },
  "otel-mutfak-ekipman-tedarik": {
    konsept: "otel mutfak ekipman tedariki",
    pfosKonu: "Otel",
    budget: "2 - 8 milyon TL",
    blocks: [
      "Gün boyu servis döngüsü ekipman yoğunluğunu artırır.",
      "Kahvaltı piki yıkama ve sıcak tutmayı belirler.",
      "Banket akşamları catering benzeri pik üretir.",
      "All day dining rehberi ile örtüşür.",
      "PFOS otel ve All day dining konseptleri kullanılır.",
    ],
    rehberLinks: "İlgili: /all-day-dining-kurulumu, /rehber/otel-mutfak-ekipman-planlama-2026.",
  },
  "oztiryakiler-ekipmani-tedarik": {
    konsept: "Öztiryakiler ekipmanı tedarik",
    pfosKonu: "Restoran",
    budget: "kalem bazlı",
    blocks: [
      "Equsto Öztiryakiler yetkili bayii kanalıyla pişirme, soğutma ve yıkama tedarik eder.",
      "Canlı katalog EUR/TL kurlarıyla güncellenir.",
      "Atalay ve seçili markalar aynı vitrinde listelenir.",
      "PFOS teklif satırları SKU koduna bağlanır.",
      "Garanti ve servis hattı resmi bayi kapsamındadır.",
    ],
    rehberLinks: "İlgili: /endustriyel-mutfak-ekipmani-turkiye, /marka.html.",
  },
  "soguk-oda-teklif": {
    konsept: "soğuk oda ve soğutma teklifi",
    pfosKonu: "Restoran",
    budget: "proje bazlı",
    blocks: [
      "Soğuk oda kapasitesi, ürün profili ve MEP birlikte değerlendirilir.",
      "Tezgah altı ve dik tip modüller vitrinde örneklenir.",
      "Soğuk hat HACCP rehberi modül ayrımını anlatır.",
      "Steakhouse dry-age yüksek hassasiyet ister.",
      "PFOS alan sorusu soğuk oda ihtiyacını işaretler.",
    ],
    rehberLinks: "İlgili: /shop/sogutma, /rehber/soguk-hat-haccp-planlama-2026.",
  },
  "havuzlu-dolap-tedarik": {
    konsept: "tezgah tipi havuzlu dolap tedariki",
    pfosKonu: "Restoran",
    budget: "200 bin - 1,2 milyon TL",
    blocks: [
      "Havuzlu dolap seçiminde mm ölçü, GN uyumu ve litre kapasitesi belirleyicidir.",
      "Prep ve servis hatlarına göre adet planlanır.",
      "Soğutma vitrininde teknik ölçü satırları listelenir.",
      "PFOS soğutma modülü adetlerini üretir.",
      "Blog ve GEO rehberlerinde havuzlu hat örneklenir.",
    ],
    rehberLinks: "İlgili: /shop/sogutma, /blog.",
  },
  "endustriyel-pisirme-ekipmanlari": {
    konsept: "endüstriyel pişirme ekipmanları",
    pfosKonu: "Restoran",
    budget: "300 bin - 2 milyon TL",
    blocks: [
      "Kuzine, ocak, fritöz, ızgara ve kaynatma menüye göre adetlendirilir.",
      "Gazlı ve elektrikli modüller CE uyumlu seçeneklerle vitrinde listelenir.",
      "Davlumbaz debisi pişirme yöntemine göre bantlanır.",
      "Steakhouse ve fast food rehberleri hat yoğunluğunu farklılaştırır.",
      "PFOS pişirme zorunlu kalemlerini kural setiyle üretir.",
    ],
    rehberLinks: "İlgili: /shop/pisirme, /steakhouse-kurulumu.",
  },
  "mutfak-teklif-platformu": {
    konsept: "mutfak teklif platformu PFOS",
    pfosKonu: "Restoran",
    budget: null,
    blocks: [
      "Proje Fabrikası konsept, kapasite ve menü girdileriyle ekipman listesi üretir.",
      "Hedef 5 dakikada teklif özeti; satış mühendisliği onayıyla kesinleşir.",
      "B2B endüstriyel mutfak platformudur; tüketici yemek siparişi değildir.",
      "EQ-SK seri numarası ve Excel v14 çıktısı finans onayına sunulur.",
      "GEO aramalarında teklif motoru ve vitrin aynı marka altında konumlanır.",
    ],
    rehberLinks: "İlgili: /pfos, /restoran-mutfak-teklif.",
  },
  "bar-tasarimi-turkiye": {
    konsept: "bar tasarımı Türkiye Besos",
    pfosKonu: "Bar",
    budget: "500 bin - 3 milyon TL",
    blocks: [
      "Bar Design Studio modüler istasyonları saha ölçüsüne göre seçilir.",
      "Vitrum Group menşeli modüller Besos vitrininde listelenir.",
      "IMT300 berrak buz içecek ağırlıklı projelere eklenir.",
      "PFOS Bar konsepti modül adetlerini üretir.",
      "İzmir modüler bar demode vaka ile okunur.",
    ],
    rehberLinks: "İlgili: /besos, /projeler/izmir-moduler-bar-icecek-demode.",
  },
  "en/industrial-kitchen-supplier-turkey": {
    konsept: "industrial kitchen supplier Turkey",
    pfosKonu: "Restaurant",
    budget: "project-based",
    blocks: [
      "Equsto supplies commercial kitchen equipment for restaurants, hotels, cloud kitchens and catering in Turkey and export markets.",
      "Authorized Öztiryakiler distribution with live SKU catalog.",
      "Project Factory quote summary target about 5 minutes.",
      "Cooking, refrigeration, warewashing, prep, coffee and beverage lines are listed with mm dimensions.",
      "B2B only; not a consumer food ordering app.",
    ],
    rehberLinks: "Related: /en/commercial-kitchen-quotation, /endustriyel-mutfak-ekipmani-turkiye.",
  },
  "en/commercial-kitchen-quotation": {
    konsept: "commercial kitchen quotation platform",
    pfosKonu: "Restaurant",
    budget: null,
    blocks: [
      "Project Factory generates equipment lists and priced summaries from capacity and concept inputs.",
      "VAT and logistics lines included in quote file.",
      "Final pricing confirmed by sales engineering after site survey.",
      "Equipment rows link to live product pages for AI-readable SKU data.",
      "Turkish catalog and EN landing pages cross-link for GEO clusters.",
    ],
    rehberLinks: "Related: /en/industrial-kitchen-supplier-turkey, /pfos.",
  },
  blog: {
    konsept: "Equsto rehber ve blog GEO dizini",
    pfosKonu: "Restoran",
    budget: null,
    blocks: [
      "Bu dizin vitrin menüsünden ayrı programatik rehberleri listeler.",
      "Konsept kurulum, GEO hedef, editoryal rehber ve referans proje bölümleri içerir.",
      "Her sayfa FAQ ve vitrin SKU tablosu taşır; uygun sayfalarda 1000+ sözcük gövde yayınlanır.",
      "PFOS hedef 5 dakikada teklif özeti üretir.",
      "llms.txt ve sitemap ile dizinlenir.",
    ],
    rehberLinks: "İlgili: /pfos, /llms.txt.",
  },
};

/** geo-landings.json’da kayıt yoksa minimal meta ekle */
const MISSING_META = {
  "hamburger-istasyonu": {
    profile: "fastfood",
    title: "Hamburger istasyonu kurulum rehberi | Equsto",
    description: "Hamburger ve burger mutfak hattı: ızgara, fritöz, prep, soğutma; PFOS ile teklif.",
    h1: "Hamburger istasyonu",
    lead: "Burger odaklı mutfaklarda yüksek ısı pişirme, yağ yönetimi ve paket oranı hat adedini belirler.",
  },
  yersofrasi: {
    profile: "catering",
    title: "Yer Sofrası — banket ve büfe servis | Equsto",
    description: "Yer Sofrası: chafing, büfe ısıtıcı, GN taşıyıcı; catering ve otel banket projeleri.",
    h1: "Yer Sofrası",
    lead: "Açık büfe ve banket servis ekipmanları üretim mutfağından ayrı zonlanır; catering rehberleriyle birlikte okunur.",
  },
  "rehber/otel-mutfak-ekipman-planlama-2026": {
    profile: "rehberOtel",
    title: "Otel mutfak ekipman planlama | Equsto",
    description: "Otel mutfak planlama 2026: kahvaltı–banket döngüsü, soğutma, yıkama; PFOS senaryoları.",
    h1: "Otel mutfak ekipman planlama",
    lead: "Ana mutfak, banquet ve pastane hatları ayrı modellenir; ortak yıkama toplam tabak yükünü taşır.",
  },
  "rehber/davlumbaz-havalandirma-secimi-2026": {
    profile: "rehberDavlumbaz",
    title: "Davlumbaz ve havalandırma seçimi | Equsto",
    description: "Davlumbaz debisi, baca, yağ sıyırıcı ve statik basınç; MEP öncesi planlama rehberi.",
    h1: "Davlumbaz ve havalandırma seçimi",
    lead: "Havalandırma ekipman siparişinden önce MEP ile kilitlenir; yanlış debi ruhsat riski üretir.",
  },
  "rehber/endustriyel-yikama-kapasitesi-2026": {
    profile: "rehberYikama",
    title: "Endüstriyel yıkama kapasitesi | Equsto",
    description: "Yıkama hattı kapasite formülü: pik tabak, döngü süresi, konveyör; catering ve restoran örnekleri.",
    h1: "Endüstriyel yıkama kapasitesi",
    lead: "Yıkama darboğazı servisi durdurur; pik tabak ve servis penceresiyle sepet/saat hesaplanır.",
  },
  "rehber/soguk-hat-haccp-planlama-2026": {
    profile: "rehberSogukHat",
    title: "Soğuk hat ve HACCP planlama | Equsto",
    description: "Soğuk zincir modülleri, alarm, kayıt ve denetim; prep, depolama, donmuş girdi ayrımı.",
    h1: "Soğuk hat ve HACCP planlama",
    lead: "Ham madde kabulünden servise kesintisiz sıcaklık kontrolü; modüller zonlara ayrılır.",
  },
  "rehber/paket-servis-mutfak-orani-2026": {
    profile: "rehberPaket",
    title: "Paket servis oranı ve mutfak planlama | Equsto",
    description: "Paket oranı eşikleri: soğutma, prep, yıkama ve dark kitchen geçişi; PFOS servis modeli.",
    h1: "Paket servis oranı ve mutfak",
    lead: "Oran yükseldikçe layout fast food ve bulut mutfak mantığına yaklaşır.",
  },
  "rehber/bulut-mutfak-operatoreleri-turkiye-2026": {
    profile: "rehberOperator",
    title: "Bulut mutfak operatörleri Türkiye | Equsto",
    description: "Cloud kitchen operatörleri: çok markalı ruhsat, parsel, MEP; Mizanplus ve Paket Mutfak profilleri.",
    h1: "Bulut mutfak operatörleri — Türkiye",
    lead: "Operatör aramaları ekipman upgrade ve yeni parsel açılışı ile kesişir; PFOS marka başına senaryo üretir.",
  },
};
...
for (const [key, meta] of Object.entries(MISSING_META)) {
  if (!data[key]) data[key] = meta;
}
const report = [];
...
data.version = 10;
data.source =
  "llms.txt + PFOS SEO + editoryal rehber 2026 (1000+ sözcük, 2 paragraf) v10";
