  ...
  var NAV = [
    ...
    },
    {
      ...
      subs: [
        ...
        { label: "Helvane ve Sığ Tencereler", tip: "helvane-sig-tencere", search: "helvane|sığ tencere" },
        { label: "Silindirik Tencereler", tip: "silindirik-tencere", search: "silindirik tencere" },
        { label: "Kaçarola ve Buharlı Pişiriciler", tip: "kaserola-buharli", search: "kaçarola|buharlı pişirici" },
        { label: "Tavalar", tip: "tavalar", search: "tava" },
        { label: "Bakır Sunum Ekipmanları", tip: "bakir-sunum", search: "bakır sunum" },
        { label: "Döküm Tencere ve Tavalar", tip: "dokum-tencere-tava", search: "döküm tencere|lava döküm" },
        { label: "Masaüstü Ekipmanları", tip: "masaustu-ekipman", search: "masaüstü" },
        { label: "Gastronorm Küvetler", tip: "gastronorm-kuvet", search: "gastronorm|gn küvet" },
        { label: "Pres Baskı Tepsiler", tip: "pres-baski-tepsi", search: "pres baskı" },
        { label: "Taşıma Ekipmanları", tip: "tasima-ekipman", search: "taşıma ekipman|servis arab" },
        { label: "Bain Marie Kapları", tip: "bain-marie-kap", search: "bain marie" },
        { label: "Melamin Sunum Kapları", tip: "melamin-sunum", search: "melamin sunum" },
        { label: "Karıştırma Kapları", tip: "karistirma-suzgec", search: "karıştırma kap|süzgeç" },
        { label: "Polipropilen / Polikarbonat GN", tip: "pp-pc-gn", search: "polipropilen|polikarbonat" },
        { label: "Polietilen Kesme Tahtaları", tip: "kesme-tahtasi", search: "kesme tahta" },
        { label: "Gurmeaid Bıçaklar", tip: "gurmeaid-bicak", search: "gurmeaid.*bıçak" },
        { label: "Gurmeaid Aksesuarlar", tip: "gurmeaid-aksesuar", search: "gurmeaid.*aksesuar" },
        { label: "Mutfak Aksesuarları", tip: "mutfak-aksesuar", search: "mutfak aksesuar" },
        { label: "Sinek Öldürücü", tip: "sinek-oldurucu", search: "sinek öldürücü" },
        { label: "Sıcak / Soğuk Servis", tip: "sicak-soguk-servis", search: "sıcak.*soğuk servis" },
        { label: "Isıtıcı Lambalar", tip: "isitici-lamba", search: "ısıtıcı lamba" },
        { label: "Patlamış Mısır / Pamuk Şeker", tip: "patlamis-pamuk", search: "mısır patlatma|pamuk şeker" },
      ],
    },
    {
      id: "servis",
