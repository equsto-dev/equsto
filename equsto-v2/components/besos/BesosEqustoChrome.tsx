...
/** Ana sayfa (index.html) üst chrome — Besos’ta yalnızca siyah zemin (besos-shell.css) farklı */
        ...
        >
          ...
          <div className="hdr-right">
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: "var(--eq-text)" }}>Alışveriş Sepeti</span>
            </div>
          </div>
        </div>
      </header>
