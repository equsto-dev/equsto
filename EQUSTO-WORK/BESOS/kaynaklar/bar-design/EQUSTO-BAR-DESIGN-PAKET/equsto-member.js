...
(function () {
  ...
  window.equstoSetMemberActive = function (extra) {
    try {
      ...
      if (window.EqustoCart && typeof window.EqustoCart.syncFromServer === "function") {
        window.EqustoCart.syncFromServer();
      }
    } catch (e) {}
  };
  ...
  function bootMemberUi() {
    ...
    } else if (window.EqustoCart && typeof window.EqustoCart.syncFromServer === "function" && equstoIsMemberLoggedIn()) {
      window.EqustoCart.syncFromServer();
    }
