...
export default function YonetimAramaPage() {
  ...
  return (
    <PageContainer title="Arama" subTitle="Meilisearch — canlı mağaza /api/search">
      <ProCard title="Yapılandırma" style={{ marginBottom: 16 }}>
        <ProDescriptions
          ...
          columns={[
            ...
            { title: "Eksik env", dataIndex: "missing", render: (v) => JSON.stringify(v) },
          ]}
        />
      </ProCard>
      ...
      <Alert
        ...
        description={
          <>
            Yerelde: <Typography.Text code>npm run search:index</Typography.Text> — kaynak{" "}
