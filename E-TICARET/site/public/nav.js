...
(function () {
  ...
  var NAV = [
    ...
    { id: "bar-design", labelKey: "nav.bar_design", label: "Bar Design", href: "/besos" },
    {
      ...
      subs: [
        ...
        { label: "Kömürlü Izgaralar", labelKey: "nav.sub.komurlu_izgara", tip: "komurlu-izgara" },
    ...
    { id: "tezgah", labelKey: "nav.tezgah", label: "Tezgahlar", href: "tezgah.html" },
  ...
  var EQ_PHOTO_SEARCH_ASSET_V = "20260622-vision-json-parse";
