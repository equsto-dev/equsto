...
(function () {
  ...
  var PROFILES = {
    ...
    catering: {
      ...
      pfosKonu: "Catering",
      body:
        "<p>Catering mutfağında yüksek hacim pişirme, taşıma ekipmanları ve konveyörlü yıkama aynı senaryoda modellenir. Banket çıkışlarında sıcak holding süresi menü mühendisliğini belirler; soğuk zincir derinliği ürün portföyüne göre ayrılır.</p><p>Pik kişi sayısı ve öğün aralığı ocak, soğutma ve yıkama adetlerini doğrudan etkiler. Taşıma ve termobox kapasitesi sevkiyat planıyla birlikte okunmalıdır.</p><p>Aşağıdaki tablo vitrin örneklerini gösterir. Tam liste Proje Fabrikası’nda kişi ve öğün profiliyle üretilir; saha keşfi montaj takviminin ilk adımıdır.</p><p>Banket ve toplu yemek senaryolarında taşıma ekipmanları ile termobox kapasitesi menü profiline göre eklenir. 2026 catering projelerinde pik kişi sayısı yıkama hızını belirler; saha keşfi montaj takviminin ilk adımıdır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    fastfood: {
      ...
      pfosKonu: "Fast food",
      body:
        "<p>Fast food hattında fritöz ve ızgara yoğunluğu, soğutma stok derinliği ile hızlı yıkama kritiktir. Menü karması ekipman adetlerini doğrudan etkiler; paket ağırlığı yükseldikçe hazırlık ve muhafaza modülleri artar.</p><p>Servis süresi kısa olduğundan hat dizilimi paralel çalışır; sıcak holding ve soğuk stok aynı koridorda net ayrılır. Tezgah yüksekliği ve ergonomi ekip verimini etkiler.</p><p>Örnek SKU tablosu vitrine bağlanır. Kapasite girdileri PFOS’ta netleştirilir; liste iletişim veya Proje Fabrikası ile tamamlanır.</p><p>Paket ağırlığı yükseldikçe hazırlık, muhafaza ve soğutma modülleri artar. 2026 fast food hatlarında fritöz ve ızgara yoğunluğu menü karmasıyla doğrudan orantılıdır. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    bulut: {
      ...
      body:
        "<p>Bulut mutfakta marka başına parsellenmiş sıcak ve soğuk hatlar ile ortak yıkama merkezi planlanır. Çok markalı senaryoda elektrik, havalandırma ve yağ sıyırıcı kapasitesi toplam menüye göre hesaplanır.</p><p>Parsel bazlı üretim akışı çapraz bulaşmayı azaltır; ortak depo ve sevkiyat alanı markalar arasında net sınırlandırılır. Paket oranı yüksek markalarda hazırlık modülleri ayrı tutulur.</p><p>Örnek ekipman tablosu vitrin SKU’larına gider. PFOS çok markalı çıkışı modellemek için kullanılır; saha ölçüsü planın ilk girdisidir.</p><p>Çok markalı senaryoda MEP yükü toplam menüye göre hesaplanır; yağ sıyırıcı kapasitesi erken doğrulanmalıdır. 2026 bulut mutfak projelerinde marka sayısı ve saha ölçüsü planın ilk girdileridir. Liste Proje Fabrikası’nda tamamlanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    allday: {
      ...
      body:
        "<p>All day dining ve otel mutfağında kahvaltı, öğle ve akşam döngüsü aynı ekipmanı farklı yüklerle kullanır. Kahve istasyonu, sıcak hat ve soğuk stok gün boyu paralel yürür; banket çıkışlarında kapasite kısa sürede yükselir.</p><p>Öğün profili soğutma derinliğini ve yıkama hızını belirler. Oda servisi ve açık büfe aynı mutfakta farklı ekipman yoğunluğu oluşturabilir.</p><p>Aşağıdaki tablo örnek modülleri gösterir. Kişi sayısı ve otel segmenti Proje Fabrikası’nda girilerek liste tamamlanır.</p><p>Kahvaltı piki yıkama ve kahve hatlarını belirler; banket çıkışları kısa sürede kapasiteyi yükseltir. 2026 otel ve all day dining projelerinde öğün profili soğutma derinliğini etkiler. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    marketKasap: {
      ...
      body:
        ...
        "<p>Market kurulumunda müşteri yolculuğu reyondan başlar. Dondurulmuş ada, soğutmalı gondol ve kasap bankosu aynı koridorda dizilir; hazırlık ve depo arkada ayrılır. Kasap hattında kıyma, dilimleme ve vitrin sergisi farklı zonlardadır.</p><p>Hijyen zonları kasap hazırlık hattında et tahtası, el yıkama ve hızlı yıkama modülleriyle tamamlanır. 2026 market projelerinde reyon genişliği soğutucu adedini belirler. Teklif özeti satış mühendisliği onayıyla kesinleşir. Liste Proje Fabrikası’nda tamamlanır.</p><p>Hijyen zonları kasap hazırlık hattında et tahtası, el yıkama ve hızlı yıkama modülleriyle tamamlanır. 2026 market projelerinde reyon genişliği soğutucu adedini belirler. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
        [
    ...
    projelerHub: {
      ...
      budget: null,
      body:
        "<p>Equsto referans sayfaları demonte vaka anlatımı sunar: proje yaşam döngüsü, zorunluluklar ve ekipman mantığı şeffaf biçimde okunur. Gerçek müşteri fotoğrafı ve alıntılar yayın sürecinde pekiştirilir; sayfalar satılabilir paket değildir.</p><p>Her vaka vitrin SKU’larına köprü kurar; teklif Proje Fabrikası veya iletişim hattıyla netleşir. Demonte anlatım saha koşullarını örnekler, kesin liste projeye özel üretilir.</p><p>Aşağıdaki bağlantılardan İstanbul catering ve İzmir modüler bar örneklerine geçebilirsiniz. PFOS aynı mantığı canlı listeye dönüştürür.</p><p>Demonte vakalar saha koşullarını örnekler; kesin ekipman listesi projeye özel üretilir. 2026 referans sayfaları vitrin SKU’larına köprü kurar. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    projeIstanbul: {
      ...
      budget: null,
      body:
        "<p>İstanbul yüksek hacim catering demode diziliminde sıcak banket, yüksek kapasiteli pişirme ve konveyörlü yıkama aynı senaryoda modellenir. Toplu yemek ve banket çıkışlarında pik dakika yıkama hızını belirler.</p><p>Cephe kapasitesi ve baca kuyusu netleştirilmeden sipariş risklidir; saha ölçüsü önce alınır. Taşıma ve termobox ihtiyacı sevkiyat planıyla birlikte değerlendirilir.</p><p>PFOS’ta Catering konsepti ve şehir seçimiyle aynı mantık canlı listeye dönüşür. Aşağıdaki tablo örnek SKU’ları gösterir.</p><p>Yoğun şehir içi cateringde cephe kapasitesi ve baca kuyusu sipariş öncesi doğrulanmalıdır. 2026 demode diziliminde konveyörlü yıkama pik dakikada darboğaz oluşturmamalıdır. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    projeIzmir: {
      ...
      budget: null,
      body:
        "<p>İzmir modüler bar ve içecek demode diziliminde Besos modülleri ile içecek ekipmanları aynı saha projesinde hizalanır. Vitrum Group menşeli bar çözümleri Bar Design Studio altında listelenir; servis akışı modül seçimini belirler.</p><p>Soğutmalı içecek hattı, kahve ve hazırlık modülleri bar ölçüsüne göre parsellenir. Elektrik ve su noktaları modül yerleşiminden önce doğrulanır.</p><p>Besos vitrininde kırk iki modül örneği bulunur. Tam liste Proje Fabrikası veya iletişimle netleşir.</p><p>Bar ölçüsü modül parsellemesini belirler; elektrik ve su noktaları yerleşimden önce kontrol edilir. 2026 modüler bar projelerinde Besos vitrininde kırk iki örnek modül listelenir. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    rehberM2: {
      ...
      budget: null,
      body: "<p>Kişi başı mutfak metrekare planlamasında servis stili belirleyicidir: oturma, paket ve banket aynı m²’yi farklı kullanır. Yoğun paket oranı soğutma derinliğini artırır; oturma ağırlıklı işletmede sıcak tutma süreleri öne çıkar.</p><p>Alan hesabında servis hızı, menü karmaşıklığı ve eşzamanlı üretim dikkate alınır. Dar mutfaklarda dikey depolama ve modüler tezgahlar tercih edilir.</p><p>PFOS alan ve kişi sayısı soruları aynı mantığı otomatikler. Bu yazı 2026 kapasite varsayımlarıyla güncellenir; footer ve sitemap üzerinden erişilir.</p><p>2026 kapasite varsayımları oturma, paket ve banket senaryolarını ayrı okur. Kişi başı metrekare rehberi footer ve sitemap üzerinden erişilir; PFOS alan soruları aynı mantığı otomatikler. Liste Proje Fabrikası’nda tamamlanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoTurkiye: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Türkiye’de endüstriyel mutfak ekipmanı arayan işletmeler için Equsto; pişirme, soğutma, yıkama, hazırlık, kahve ve içecek departmanlarında canlı katalog ve satış mühendisliği sunar. Restoran, otel, kafe ve bulut mutfak aynı akışta modellenir.</p><p>Öztiryakiler yetkili bayii kanalı ve seçili global markalar aynı sepet ve teklif akışında birleşir. Tek ürün siparişinden anahtar teslim projeye aynı vitrin kullanılır.</p><p>Aşağıdaki tablo örnek SKU’lara gider. Tam liste Proje Fabrikası’nda üretilir; ihracat pazarları için iletişim hattı açıktır.</p><p>Türkiye geneli ve seçili ihracat pazarlarında canlı katalog ve satış mühendisliği aynı akışta yürür. 2026 endüstriyel mutfak aramalarında tüm departmanlar tek vitrinde listelenir; ihracat için iletişim hattı açıktır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoRestoranTeklif: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Restoran mutfak teklifi için menü, kapasite ve servis stili girilir; PFOS sıcak, soğutma ve yıkama adetlerini kural setiyle üretir. Teklif özeti KDV ve lojistik kalemlerini içerir; nihai tutar satış mühendisliği onayıyla kesinleşir.</p><p>İlk aşamada kapasite ve konsept yeterlidir; yerleşim Gastronomi Tasarımı ile derinleşir. CAD plan sonraki adımda eklenebilir.</p><p>Hedef süre yaklaşık beş dakikadır. Çıktı ön teklif dosyası olarak kullanılır; onay sonrası sipariş süreci başlar.</p><p>Menü, kapasite ve servis stili PFOS kural setinin temel girdileridir. 2026 restoran tekliflerinde KDV ve lojistik kalemleri özet dosyada yer alır. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoOtel: {
      ...
      pfosKonu: "All day dining",
      body:
        "<p>Otel mutfak ekipman tedarikinde kahvaltı, öğle ve akşam döngüsü ile banket çıkışları aynı hatları farklı yüklerle kullanır. Gün boyu servis soğutma derinliğini ve yıkama kapasitesini artırır.</p><p>Oda servisi, açık büfe ve balo menüleri aynı mutfakta farklı ekipman yoğunluğu oluşturur. Kahve ve sıcak içecek hatları kahvaltı pikinde kritik rol oynar.</p><p>All day dining rehberi ile örtüşen senaryolar PFOS’ta modellenir. Aşağıdaki tablo vitrin örneklerine bağlanır.</p><p>Kahvaltı piki kahve ve yıkama hatlarını belirler; oda servisi ile açık büfe aynı mutfakta farklı yoğunluk oluşturur. 2026 otel tedarik dosyalarında banket çıkışları kapasiteyi yükseltir. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoOzti: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Öztiryakiler ekipmanı Equsto kataloğunda pişirme, soğutma, yıkama ve hazırlık departmanlarında listelenir. Yetkili bayii ilişkisi resmi fiyat listesi ve garanti hattını kapsar; canlı kur EUR ve TL’ye uygulanır.</p><p>Atalay ve seçili markalar aynı katalogda yer alır; Öztiryakiler ana omurgadır. Teknik ölçüler mm cinsinden ürün kartlarında okunur.</p><p>Tek ürün siparişinden anahtar teslim projeye aynı vitrin kullanılır. PFOS ile liste genişletilir.</p><p>Yetkili bayii ilişkisi resmi fiyat listesi, garanti hattı ve servis yönlendirmesini kapsar. 2026 katalogda teknik ölçüler mm cinsinden ürün kartlarında okunur. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoSogukOda: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Soğuk oda teklifi için kapasite, ürün profili ve MEP koşulları birlikte değerlendirilir. Tezgah tipi ve dik tip modüller vitrin tablosunda örneklenir; soğuk oda projeleri ayrı mühendislik hattıyla yürür.</p><p>Menü ve hacim soğutma adedini belirler; şok dondurucu ihtiyacı ürün giriş sıcaklığına bağlıdır. Ön doğrulama satış mühendisliği ile yapılır.</p><p>Tam proje listesi Proje Fabrikası’nda veya iletişimle netleşir. Aşağıdaki tablo vitrin modüllerine örnektir.</p><p>Soğuk oda projeleri ayrı mühendislik hattıyla yürür; tezgah ve dik tip modüller vitrin tablosunda örneklenir. 2026 soğuk zincir planlamasında menü ve hacim soğutma adedini belirler. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoHavuzlu: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Havuzlu tezgah tipi dolap seçiminde dış ölçü, GN uyumu ve kapasite vitrin kartında listelenir. Hazırlık ve servis hattına göre adet ve derinlik değişir; mm cinsinden teknik ölçü satırı ürün detayında bulunur.</p><p>Tezgah altı ve tezgah üstü modeller aynı hatta birlikte planlanır. Enerji ve soğutma tipi saha tesisatına göre seçilir.</p><p>Soğutma departmanı vitrininden benzer modüller karşılaştırılabilir. PFOS veya ürün sayfası üzerinden teklif satırına eklenebilir.</p><p>GN uyumu ve dış ölçü vitrin kartında listelenir; hazırlık hattına göre adet ve derinlik değişir. 2026 havuzlu tezgah seçiminde enerji tipi saha tesisatına göre belirlenir. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoPisirme: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Endüstriyel pişirme hattında kuzine, ocak, fritöz, ızgara ve kaynatma modülleri menüye göre adetlendirilir. Gazlı ve elektrikli seçenekler vitrinde; saha gaz ve elektrik kapasitesine göre seçilir.</p><p>Pik çıkış ve eşzamanlı üretim ocak yayılımını belirler. Davlumbaz kapasitesi pişirme adediyle birlikte hesaplanır.</p><p>Aşağıdaki tablo örnek SKU’lara gider. Tam liste Proje Fabrikası’nda konsept ve kapasiteyle üretilir.</p><p>Gazlı ve elektrikli seçenekler saha tesisatına göre filtrelenir. 2026 pişirme hatlarında davlumbaz kapasitesi ocak adediyle birlikte hesaplanır; pik çıkış cookline yayılımını belirler. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
    ...
    seoTeklifPlatform: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Proje Fabrikası, Equsto’nun teklif platformudur: konsept, kapasite ve menü girdileriyle ekipman listesi ve fiyat özeti üretir. Hedef süre yaklaşık beş dakikadır; çıktı satış mühendisliği onayıyla kesinleşir.</p><p>B2B endüstriyel mutfak tedarik akışıdır; rezervasyon veya masa yönetimi değildir. Kural motoru menü ve kapasiteye göre modül adetlerini üretir.</p><p>Teklif PDF’inde SKU ve ürün kodu satırları yapılandırılmış biçimde yer alır. Onay sonrası sipariş ve montaj planı başlar.</p><p>Kural motoru menü ve kapasiteye göre modül adetlerini üretir. 2026 teklif PDF’lerinde SKU satırları yapılandırılmış biçimde yer alır. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    seoEnIndustrial: {
      ...
      pfosKonu: "Restaurant",
      body:
        "<p>Equsto is a Turkey-based industrial kitchen platform for restaurants, hotels, cloud kitchens and catering. Authorized Öztiryakiler distribution covers cooking, refrigeration, warewashing, prep, coffee and beverage lines in one catalog flow.</p><p>Export markets include selected countries in the Gulf, Central Asia and Eastern Europe. Single-SKU orders and full project lists use the same catalog and quote workflow.</p><p>Quote summaries are generated via Project Factory in about five minutes. Final pricing and logistics are confirmed by sales engineering before purchase orders are issued.</p><p>Export markets include the Gulf, Central Asia and Eastern Europe. 2026 quote summaries via Project Factory take about five minutes before sales engineering sign-off. Complete the equipment list via Project Factory or contact; installation is planned with sales engineering.</p>",
      faq: [
    ...
    seoEnQuotation: {
      ...
      pfosKonu: "Restaurant",
      body:
        "<p>Project Factory generates equipment lists and quote summaries for commercial kitchen projects. Capacity, concept and menu inputs drive module counts; VAT and logistics lines are included in the output file.</p><p>Target turnaround is about five minutes. Layout and MEP can be refined later with gastronomy design and sales engineering on site.</p><p>This is B2B kitchen equipment supply, not table reservation software. Final sign-off is performed by the sales engineering team before purchase orders are issued.</p><p>VAT and logistics lines are included in the output file. 2026 commercial kitchen projects start from capacity and concept inputs in Project Factory. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Complete the equipment list via Project Factory or contact; installation is planned with sales engineering.</p>",
    ...
    blogHubEn: {
      ...
      budget: null,
      body:
        "<p>This index separates blog and GEO guide content from the shop menu. Users looking for equipment stay in the catalogue; concept and quote questions are answered on these pages. Each guide includes FAQs and, where relevant, a catalogue SKU table.</p><p>Concept setup, search-targeted pages, editorial guides and reference projects are grouped in sections below. Links are indexed via footer, sitemap and llms.txt. This is the main entry point for Project Factory quote summaries.</p><p>Steakhouse, cloud kitchen, market aisle and cafe opening guides link to their concept profiles. Five-hundred-guest catering and square-metre planning articles deepen capacity questions. The restaurant checklist flow mirrors the PFOS sequence.</p><p>SEO pages address searches for industrial kitchen equipment in Turkey, hotels, cooking lines, cold rooms and the quote platform. English industrial and quotation pages target export readers. The Öztiryakiler dealer page explains the official channel.</p><p>Reference projects use a demount case-study format; Istanbul catering and Izmir modular bar examples are reachable from this index. Photography and quotes will be updated as publishing continues. The definitive equipment list is generated in PFOS.</p><p>Catalogue SKU tables show sample modules only; the full list is project-specific. 2026 prices are summarised excluding VAT. Project discounts are applied during quoting.</p><p>Sales engineering approval sets the final price. Installation and commissioning follow the project plan. This is a B2B platform, not reservation software.</p><p>Gastronomy Design deepens layout questions. A CAD plan can be added in a later phase. Site survey dimensions are the foundation for PFOS inputs.</p><p>Service areas cover Turkey and selected export markets. The contact channel handles bespoke content and project requests. The live catalogue validates price and stock.</p><p>The guide index separates equipment shoppers from concept researchers. Transition to PFOS is encouraged for quote production. The footer menu links to every guide.</p><p>Dark kitchen and cloud kitchen guides explain multi-brand scenarios. Hotel and all-day dining content emphasises meal cycles. Fast food and fine dining can be read comparatively.</p><p>Quote PDFs contain structured SKU rows. Target draft quote time is about five minutes. The ordering process starts after approval.</p><p>The GEO guide index is the central content architecture hub for Equsto.</p><p>PFOS draft lists are finalised after sales engineering approval and site survey; installation, commissioning and warranty registration run under the same project number. Equsto generates quotes as a B2B industrial kitchen supply platform with 2026 pricing.</p>",
      faq: [
    ...
    rehberDarkKitchen: {
      ...
      pfosKonu: "Bulut mutfak",
      body:
        "<p>Dark kitchen ve bulut mutfak kurulumunda marka başına parsellenmiş sıcak-soğuk hatlar ve ortak yıkama merkezi planlanır. Elektrik ve havalandırma yükü çok markalı senaryoda artar; yağ sıyırıcı kapasitesi toplam menüye göre hesaplanır.</p><p>Yüksek paket oranı soğutma ve hazırlık modülleri artırır. Markalar arası depo ve sevkiyat alanı net sınırlandırılmalıdır.</p><p>Bulut mutfak kurulum rehberi ile örtüşen adımlar PFOS’ta modellenir. Saha ölçüsü planın ilk girdisidir.</p><p>Markalar arası depo ve sevkiyat alanı net sınırlandırılmalıdır. 2026 dark kitchen rehberi çok markalı ruhsat senaryosunda MEP kapasitesini vurgular. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Teklif özeti satış mühendisliği onayıyla kesinleşir. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    rehberRestoranChecklist: {
      ...
      pfosKonu: "Restoran",
      body:
        "<p>Restoran mutfak kurulumu checklist akışı: menü, kapasite, alan, sıcak-soğuk-yıkama adetleri ve teklif. PFOS bu sırayı otomatikler; checklist saha toplantılarında manuel kontrol içindir.</p><p>İşletme tipi, oturma ve paket oranı, günlük öğün, mevcut tesisat, davlumbaz ve marka tercihi sırayla netleştirilir. Her adım sonraki modül adedini etkiler.</p><p>CAD plan ilk aşamada şart değildir; yerleşim Gastronomi Tasarımı ile derinleşir. Restoran teklif rehberi ile birlikte okunmalıdır.</p><p>Checklist saha toplantılarında manuel kontrol içindir; PFOS menü-kapasite-alan-teklif sırasını otomatikler. 2026 restoran açılışlarında tesisat ve davlumbaz rotası modül adedini etkiler. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
    ...
    rehberKafeAcilis: {
      ...
      pfosKonu: "Cafe",
      body:
        "<p>Kafe açılış ekipman listesinde espresso merkezi, soğutmalı stok, hazırlık tezgahı, vitrin soğutucu ve yıkama hattı omurgayı oluşturur. Su filtrasyonu ve basınç doğrulaması makine seçiminden önce sabitlenmelidir.</p><p>Pastane ağırlıklı kafelerde fırın ve hazırlık modülleri eklenir. Paket oranı soğutma derinliğini artırır; oturma kapasitesi bardak adedini belirler.</p><p>Cafe kurulum rehberi ve kahve vitrini ile birlikte okunmalıdır. Liste Proje Fabrikası’nda tamamlanır.</p><p>Espresso merkezi ve soğuk stok cafe konseptinde paralel planlanır; paket oranı soğutma derinliğini artırır. 2026 kafe açılış listesinde su filtrasyonu makine seçiminden önce sabitlenmelidir. 2026 fiyatları KDV hariç özetlenir; proje iskontoları teklif sırasında uygulanır. Detaylı ekipman listesi Proje Fabrikası veya iletişim hattı üzerinden tamamlanır; montaj planı satış mühendisliği ile yürütülür.</p>",
      faq: [
