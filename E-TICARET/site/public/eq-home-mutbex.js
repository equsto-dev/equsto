...
(function (global) {
  ...
  var categoryCovers = {
    ...
    byGo: {
      pfos: '/images/pfos/proje-fabrikasi-bar-eskiz.png?v=20260603bar-eskiz',
  ...
  function getStories() {
    ...
    return [
      { label: 'Proje Fabrikası', go: 'pfos', emoji: '📋', bg: '#dce8f4', frame: '#9eb8d4', image: '/images/pfos/proje-fabrikasi-bar-eskiz.png?v=20260603bar-eskiz' },
