...
body.eq-shop.eq-home .right-col .eq-home-hero-mount>section.hero.eq-home-hero-ads{display:grid;grid-template-columns:repeat(3,1fr);overflow:hidden}
...
@media(max-width:768px){body.eq-shop.eq-home .right-col .eq-home-hero-mount>section.hero.eq-home-hero-ads{grid-template-columns:1fr}}
`.trim();

export const HOME_BODY_CLASS = "eq-shop eq-home eq-home-mutbex eq-home-decor";

export const HOME_EXTRA_STYLES = [
  `/eq-home-equsto.css?v=${v}&m=20260918-seo-paths`,
...
export const HOME_SCRIPTS = [
  ...
  `/eq-home-mutbex.js?v=${v}&m=20260918-seo-href`,
