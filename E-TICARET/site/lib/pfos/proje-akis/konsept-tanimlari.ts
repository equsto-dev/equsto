...
export const PFOS_KONSEPT_SHOP_TYPES: ShopTypeKayit[] = [
  ...
  },
  {
    ...
    name: "Kokteyl + Kahve",
    parent: "Bar & Lounge",
    desc: "Kokteyl & kahve bar · 30–200 m² referans (No Fish Today) · motor: kokteyl-kahve",
    pfos: {
      motorSlug: "kokteyl-kahve",
      dukkanSecim: "Kokteyl + Kahve",
      m2Min: 30,
      m2Max: 200,
      bantKurali: "Tek referans liste (30–200 m²); m² ile adet ölçeklenir",
      listeYolu: "veri/no fish today urun_listesi.xlsx",
      teklifKaynagi: "pfos-referans",
      durum: "aktif",
      bantlar: [liste("30-50", "30–200 m²", 40, "kokteyl-kahve")],
    },
    questions: [],
  },
  {
    ...
    name: "Kokteyl Bar",
    parent: "Bar & Lounge",
    desc: "Kokteyl bar · 30–200 m² kokteyl+kahve referansı · motor: kokteyl-kahve",
    pfos: {
      motorSlug: "kokteyl-kahve",
  ...
  konseptPlanlanan("bar_irish", "Irish Pub", "Bar & Lounge", "Irish Pub", 100, 450),
  {
    ...
    name: "Mixology Bar",
    parent: "Bar & Lounge",
    desc: "Mixology · 30–200 m² kokteyl+kahve referansı · motor: kokteyl-kahve",
    pfos: {
      motorSlug: "kokteyl-kahve",
