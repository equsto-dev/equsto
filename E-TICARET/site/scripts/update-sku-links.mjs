...
const newLinks = {
  ...
  "A2": { "sku": "8897.15IP4.07", "name": "ISTIF RAFI IZGARA TABLA 46*152*183 PASLANMAZ 4 KATLI" },
  "B1": { "sku": "7919.CR3020.00", "name": "SOĞUK ODA PANEL-SPLİT TİP, 0/+5 C" },
  "B2": { "sku": "8897.14IP4.07", "name": "ISTIF RAFI IZGARA TABLA 46*137*183 PASLANMAZ 4 KATLI" },
  "C1": { "sku": "7919.CR2020.00", "name": "SOĞUK ODA PANEL-SPLİT TİP, 0/+5 C" },
  "C2": { "sku": "8897.15IP4.07", "name": "ISTIF RAFI IZGARA TABLA 46*152*183 PASLANMAZ 4 KATLI" },
  "D1": { "sku": "7758.147C8.11", "name": "EVYELİ TEZG.1G/1D SOL 3 PERDELİ TABAN RAFLI 140*70" },
  "D2": { "sku": "7919.06NMV.00", "name": "GN 600 NMV TEK INOX KAPI DIK TIP BUZDOLABI" },
  ...
  "E7": { "sku": "8897.15IP4.07", "name": "ISTIF RAFI IZGARA TABLA 46*152*183 PASLANMAZ 4 KATLI" },
...
async function main() {
  ...
  for (const [poz, item] of Object.entries(newLinks)) {
  ...
  console.log("Successfully updated public/data/pfos-referans-sku-links.json with bulut-burger mappings!");
}
