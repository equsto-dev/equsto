/**
 * 2016-064 All Sport Cafe → pfos-referans + pfos-kategoriler.json
 * Kaynak: PFOS/veri/all-sport-cafe-2016-064-1.xlsx
 * Kullanım: node scripts/import-all-sport-cafe-konsept.mjs
 */
...
const KATEGORI_ID = "all-sport-cafe";
const BANT_ID = "100-200";
const XLSX = "all-sport-cafe-2016-064-1.xlsx";
...
/** Mefftech teklif: col1=poz, col2=ürün, col5=ölçü, col9=adet (boşsa 1) */
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "All Sport Cafe 100–200 m²",
    referansM2: REFERANS_M2,
    kaynakDosya: "2016-064 ALL SPORT CAFE MEFFTECH/2016-064-1.xlsx",
    not: "All day cafe · gün boyu servis · kahve & sıcak yemek (All Sport Cafe)",
