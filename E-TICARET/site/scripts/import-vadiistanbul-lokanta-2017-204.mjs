/**
 * 2017-204 VADİİSTANBUL LOKANTA → pfos-referans + pfos-kategoriler.json
 * Kaynak: c:\D Disk\2017\2017-204 VADİİSTANBUL\2017-204-4.xlsx (Mefftech Sayfa1 formatı)
 * Kullanım: node scripts/import-vadiistanbul-lokanta-2017-204.mjs
 */
...
const KATEGORI_ID = "vadiistanbul-lokanta";
const BANT_ID = "300-500";
const REFERANS_M2 = 400;
const SRC_XLSX = path.normalize(
  "c:/D Disk/2017/2017-204 VADİİSTANBUL/2017-204-4.xlsx",
);
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "Vadi İstanbul Lokanta 300–500 m²",
    referansM2: REFERANS_M2,
    kaynakDosya: "2017/2017-204 VADİİSTANBUL/2017-204-4.xlsx",
    not: "Türk / lokanta · self servis + a la carte · 300–500 m²",
