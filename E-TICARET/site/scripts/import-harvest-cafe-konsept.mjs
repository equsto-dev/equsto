/**
 * 2016-051 Harvest Cafe Bahçeşehir → pfos-referans + pfos-kategoriler.json
 * Kaynak: PFOS/veri/harvest-cafe-2016-051-4.xlsx (HARVEST BAHÇEŞEHİR MEFFTECH)
 * Kullanım: node scripts/import-harvest-cafe-konsept.mjs
 */
...
const KATEGORI_ID = "harvest-cafe";
const BANT_ID = "100-200";
const XLSX = "harvest-cafe-2016-051-4.xlsx";
...
/** Mefftech teklif formatı: col1=poz, col2=ürün, col5=ölçü, col9=adet */
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "Harvest Cafe 100–200 m²",
    referansM2: REFERANS_M2,
    kaynakDosya: "2016-051 HARVEST BAHÇEŞEHİR MEFFTECH/2016-051-4.xlsx",
    not: "A la carte · tatlı satış · kahve ağırlıklı cafe (Harvest Bahçeşehir)",
