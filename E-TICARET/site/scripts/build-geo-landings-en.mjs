...
const pages = {
  "en/steakhouse-kitchen-setup": {
    ...
    description:
      "Steakhouse kitchen setup: dry-age, high-heat grilling, refrigeration and warewashing. Sample equipment table and FAQ. Quote via Project Factory.",
    h1: "Steakhouse kitchen setup",
    lead:
      "High-heat cooking, dry-age refrigeration and the hygiene line are modelled on one plan. The table below links to live catalogue SKUs.",
    skipBudget: true,
    body:
