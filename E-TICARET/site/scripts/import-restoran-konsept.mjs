/**
 * RESTORAN.xlsx → public/data/pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-restoran-konsept.mjs
 */
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "Büyük Restoran 500–1000 m²",
    referansM2: REFERANS_M2,
    kaynakDosya: XLSX,
    not: "Büyük yemek rezervasyonları · düğün & özel organizasyon · eğlence & etkinlik",
