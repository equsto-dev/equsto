...
export const NAME_PHRASES = [
  ...
  ["TEK CAM KAPILI", "single glass door"],
  ["TEK INOX KAPI DIK TIP BUZDOLABI", "single stainless door upright refrigerator"],
  ["TEK INOX KAPI DIK TIP", "single stainless door upright"],
  ["TEK INOX KAPI", "single stainless door"],
  ["CIFT INOX KAPI", "twin stainless door"],
  ["ÇİFT INOX KAPI", "twin stainless door"],
  ["3 INOX KAPI", "triple stainless door"],
  ["INOX KAPI", "stainless door"],
  ["DIK TIP BUZDOLABI", "upright refrigerator"],
  ["DİK TİP BUZDOLABI", "upright refrigerator"],
  ["DIK TIP", "upright"],
  ["DİK TİP", "upright"],
  ["DEEP FREEZE PANEL-SPLIT TIP", "deep freezer panel split type"],
  ["PANEL-SPLIT TIP", "panel split type"],
  ["PANEL-SPLİT TİP", "panel split type"],
  ["SPLİT TİP", "split type"],
  ["SPLIT TIP", "split type"],
  ["MAKE UP PIZZA HAZIRLIK DOLABI", "make-up pizza prep cabinet"],
  ["PIZZA HAZIRLIK DOLABI", "pizza prep cabinet"],
  ["HAZIRLIK DOLABI", "prep cabinet"],
  ["BUZ MAKINESI", "ice machine"],
  ["BUZ MAKİNESİ", "ice machine"],
  ["KG/GUN", "kg/day"],
  ["KG/GÜN", "kg/day"],
  ["GN KAP TELLI", "GN wired lid"],
  ["GN KAP TELLİ", "GN wired lid"],
  ["SOGUK ODA", "cold room"],
  ["SOĞUK ODA", "cold room"],
  ["SERVIS BANKOSU", "service counter"],
  ["SERVİS BANKOSU", "service counter"],
  ["K TIP", "Type K"],
  ["K TİP", "Type K"],
