/**
 * 8 HAMBURGER-60-150 m2 - Kopya.xlsx → pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-hamburger-kiosk-konsept.mjs
 */
...
const KATEGORI_ID = "hamburger-kiosk";
const BANT_ID = "60-100";
const XLSX = "8 HAMBURGER-60-150 m2 - Kopya.xlsx";
const REFERANS_M2 = 80;
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "Hamburger Kiosk 60–150 m²",
