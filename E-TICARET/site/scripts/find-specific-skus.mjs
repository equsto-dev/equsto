...
const queries = [
  ...
  { label: "Dizden Basmalı El Yıkama", pattern: "7822.04040" },
  ...
  { label: "Setaltı 4 Kapılı Buzdolabı", pattern: "7919.47" },
  { label: "TAG 4 Kapılı", pattern: "79E3.47" },
  { label: "Davlumbaz", pattern: "7751." },
  { label: "Davlumbaz Öztiryakiler", pattern: "7885." },
  { label: "Sıyırma Tezgahı", pattern: "7712." },
  { label: "Basket Rafı", pattern: "7897." },
  { label: "Çöp Arabası", pattern: "7962." },
  { label: "Bulaşık Makinesi 500", pattern: "075T" },
  { label: "Yer Izgarası 30*30", pattern: "7960.03" }
];
