/**
 * PIDECI 100-250m2.xlsx → public/data/pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-pideci-konsept.mjs
 */
...
const KATEGORI_ID = "pideci";
const BANT_ID = "100-250";
const XLSX = "PIDECI 100-250m2.xlsx";
