/**
 * 7 ŞARKÜTERİ - KIOSK.xlsx → public/data/pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-sarkuteri-kiosk-konsept.mjs
 */
...
const KATEGORI_ID = "sarkuteri-kiosk";
const BANT_ID = "kiosk";
const XLSX = "7 ŞARKÜTERİ - KIOSK.xlsx";
const REFERANS_M2 = 45;
