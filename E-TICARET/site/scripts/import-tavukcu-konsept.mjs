/**
 * 17 TAVUKCU.xlsx → public/data/pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-tavukcu-konsept.mjs
 */
...
const KATEGORI_ID = "tavukcu";
const BANT_ID = "80-150";
const XLSX = "17 TAVUKCU.xlsx";
const REFERANS_M2 = 115;
