/**
 * 2018-013 COFFEESHOP TRABZON → pfos-referans + pfos-kategoriler.json
 * Kaynak: c:\D Disk\2018\2018-013 COFFEESHOP TRABZON\2018-013-1.xlsx
 * Kullanım: node scripts/import-coffeeshop-trabzon-2018-013.mjs
 */
...
const KATEGORI_ID = "coffee-shop-yemek";
const BANT_ID = "250-350";
const REFERANS_M2 = 300;
const SRC_XLSX = path.normalize(
  "c:/D Disk/2018/2018-013 COFFEESHOP TRABZON/2018-013-1.xlsx",
);
...
async function main() {
  ...
  const liste = {
    ...
    bantId: BANT_ID,
    label: "Coffee Shop Trabzon 300 m²",
    referansM2: REFERANS_M2,
    kaynakDosya: "2018/2018-013 COFFEESHOP TRABZON/2018-013-1.xlsx",
    not: "Coffee shop + yemek · bar + mutfak · 300 m²",
    konseptSinif: "coffee-shop-yemek",
