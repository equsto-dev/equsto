/**
 * 06 SUSHI 40-100 m2.xlsx → public/data/pfos-referans + pfos-kategoriler.json
 * Kullanım: node scripts/import-sushi-konsept.mjs
 */
...
const KATEGORI_ID = "sushi";
const BANT_ID = "40-100";
const XLSX = "06 SUSHI 40-100 m2.xlsx";
