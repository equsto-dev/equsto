    ...
    <div className="pg">
      <div className="eq-dept-plp-layout">
        ...
        <main className="eq-dept-plp-main" id="eq-dept-plp-main">
          ...
          <p className="eq-dept-plp-lead">{meta.lead}</p>
          ...
          <div className="eq-dept-plp-toolbar">
            <button type="button" className="eq-dept-plp-filter-mob" id="eq-dept-plp-filter-mob">
              Filtrele
            </button>
            <div className="eq-dept-plp-count" id="eq-dept-plp-count" />
            <label className="eq-dept-plp-sort">
              Sıralama
              <select id="eq-dept-plp-sort" aria-label="Sıralama">
                <option value="">Karışık Sıra</option>
          ...
          <nav className="eq-dept-plp-pages" id="eq-dept-plp-pages" aria-label="Sayfalama" />
        </main>
      </div>
