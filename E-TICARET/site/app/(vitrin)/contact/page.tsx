    ...
    <VitrinShell bodyClass="eq-shop eq-contact" extraCss={CONTACT_PAGE_CSS}>
      ...
      <main className="ct-main">
        ...
        <div className="ct-actions">
          <a className="ct-a-primary" href="/pfos">
            Proje Fabrikası — mutfak teklifi
          </a>
          <a className="ct-a-secondary" href="/besos">
            Bar Design Studio — Besos
          </a>
          <a className="ct-a-secondary" href="/besos/imt300">
            IMT300 ürün sayfası
          </a>
        </div>
        <p className="ct-lead" style={{ marginBottom: 12 }}>
