...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    // M1: temel güvenlik header'ları (CSP ayrı sıkılaştırılabilir)
    ...
    return [
      ...
      { source: "/besos/:path*.mp4", headers: [{ key: "Content-Type", value: "video/mp4" }] },
      { source: "/besos/:path*.webm", headers: [{ key: "Content-Type", value: "video/webm" }] },
      { source: "/besos/:path*.jpg", headers: [{ key: "Content-Type", value: "image/jpeg" }] },
  ...
  async redirects() {
    return [
      ...
      { source: "/shop/marka/caglayan-refrigeration", destination: "/shop/market-reyonlari", permanent: true },
      { source: "/en/shop/marka/caglayan-refrigeration", destination: "/en/shop/market-reyonlari", permanent: true },
      { source: "/marka/caglayan-refrigeration", destination: "/shop/market-reyonlari", permanent: true },
