...
export const PFOS_KONSEPT_SHOP_TYPES: ShopTypeKayit[] = [
  ...
  },
  {
    ...
    parent: "Restoran",
    desc:
      "Türk / esnaf lokanta · Sütiş Şişhane 2017-006 · 200–5000 m² · motor: turk-restoran",
    pfos: {
      motorSlug: "turk-restoran",
      dukkanSecim: "Türk / Esnaf lokanta",
      m2Min: 200,
      m2Max: 5000,
      bantKurali: "Tek referans liste (Sütiş); m² ile adet ölçeklenir",
      listeYolu: "veri/sutis-sislihane-2017-006.xlsx",
      teklifKaynagi: "pfos-referans",
      durum: "aktif",
      bantlar: [
