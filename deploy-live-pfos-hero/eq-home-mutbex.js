...
(function (global) {
  ...
  var categoryCovers = {
    ...
    byGo: {
      pfos: '/images/pfos/proje-fabrikasi-mutfak.jpg?v=20260823',
  ...
  function getStories() {
    ...
    return [
      { label: 'Proje Fabrikası', go: 'pfos', emoji: '📋', bg: '#dce8f4', frame: '#9eb8d4', image: '/images/pfos/proje-fabrikasi-mutfak.jpg?v=20260823' },
